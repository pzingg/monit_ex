defmodule MonitExWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MonitExWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/monit_ex_web/templates",
        namespace: MonitExWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MonitExWeb.LayoutView, "live.html"}
